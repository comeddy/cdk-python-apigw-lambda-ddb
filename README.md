...
# Tests
Outputs: 예시
LambdaSampleStack.SampleLambdaEndpoint9FAA5D96 = https://mtocpm04rj.execute-api.us-east-2.amazonaws.com/prod
Sample API endpoint의 resource 'ddb'에 POST request로 확인해봅니다.
```shell
